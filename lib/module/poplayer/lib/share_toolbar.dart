...
class ShareToolbar extends StatelessWidget {
  ...
  ShareToolbar({required this.aid, required this.callback,  Key? key}) : super(key: key);
  @override
...
class ShareItem extends StatelessWidget {
  ...
  final String aid;
  final ShareItemTapCallback callback;
  ShareItem({required this.iconPath, required this.name, required this.aid, required this.callback});
  @override
  Widget build(BuildContext context) {
